...
public var skidmarkIntensity : float = 6f; 
public var maxMarks : int = 800; // Maximum number of marks total handled by one instance of the script.
private var markWidth : float = 0.275; //This is a private variable that is set by the options found just below. 
public var markWidthLightVehicle : float = 0.275; // The width of the light vehicle skidmarks. Should match the width of the wheel that it is used for. In meters.
public var markWidthMediumVehicle : float = 0.35; // The width of the medium vehicle skidmarks. Should match the width of the wheel that it is used for. In meters.
public var markWidthHeavyVehicle : float = 0.45; // The width of the heavy vehicle skidmarks. Should match the width of the wheel that it is used for. In meters.
public var markWidthMonsterTruck : float = 1; // The width of the monster truck skidmarks. Should match the width of the wheel that it is used for. In meters.
  
public var groundOffset : float = 0.02;	// The distance the skidmarks is places above the surface it is placed upon. In meters.
public var minDistance : float = 0.1;		// The minimum distance between two marks places next to each other. 
 
//this is an enumeration to allow a drop down menu to select the vehicle type in the Inspector 
enum VehicleType{LightVehicle, MediumVehicle, HeavyVehicle, MonsterTruck}; 
...
function CheckVehicleType() {
	...
	{ 
		case vehicleType.LightVehicle: 
			markWidth = markWidthLightVehicle;
		     break;
		case vehicleType.MediumVehicle:
			markWidth = markWidthMediumVehicle;
		     break;
		case vehicleType.HeavyVehicle:
			markWidth = markWidthHeavyVehicle;
		     break;
		case vehicleType.MonsterTruck:
			markWidth = markWidthMonsterTruck;
		     break; 
	}
}

// Function called by the wheels that is skidding. Gathers all the information needed to
// create the mesh later. Sets the intensity of the skidmark section b setting the alpha of the vertex color.
